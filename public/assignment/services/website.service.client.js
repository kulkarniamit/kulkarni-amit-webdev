(function(){
    ...
    function WebsiteService() {
        var websites = [
            ...
            {_id: "234", name : "Twitter", developerId: "456", description:"Our mission: To give everyone the power to create and share ideas and information instantly, without barriers."},
            ...
            {_id: "678", name : "Chess", developerId: "456", description:"Play chess on Chess.com - the #1 chess community with millions of members around the world. Fun stats, analysis, and training tools for players of all levels."}
        ];
